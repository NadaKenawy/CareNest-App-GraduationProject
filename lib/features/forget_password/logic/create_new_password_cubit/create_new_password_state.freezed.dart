...
/// @nodoc
abstract class $CreatePasswordStateCopyWith<T, $Res> {
  factory $CreatePasswordStateCopyWith(CreatePasswordState<T> value,
          $Res Function(CreatePasswordState<T>) then) =
      _$CreatePasswordStateCopyWithImpl<T, $Res, CreatePasswordState<T>>;
}

/// @nodoc
class _$CreatePasswordStateCopyWithImpl<T, $Res,
        $Val extends CreatePasswordState<T>>
    implements $CreatePasswordStateCopyWith<T, $Res> {
...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$CreatePasswordStateCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class _Initial<T> implements CreatePasswordState<T> {
