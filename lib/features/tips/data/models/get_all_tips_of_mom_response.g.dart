...
part of 'get_all_tips_of_mom_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetAllTipsOfMomResponse _$GetAllTipsOfMomResponseFromJson(
    ...
    GetAllTipsOfMomResponse(
      ...
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => MomTipData.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$GetAllTipsOfMomResponseToJson(
        GetAllTipsOfMomResponse instance) =>
    <String, dynamic>{
...
MomTipData _$MomTipDataFromJson(Map<String, dynamic> json) => MomTipData(
...
Map<String, dynamic> _$MomTipDataToJson(MomTipData instance) =>
    <String, dynamic>{
      '_id': instance.id,
