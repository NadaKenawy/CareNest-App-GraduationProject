...
import '../../logic/get_feedback_cubit/get_feedbacks_cubit.dart';
      ...
      builder: (context) => AlertDialog(
          ...
          children: [
            Text("Thank You!",
                style: TextStyles.font20BlackSemiMedium.copyWith(
                    color: ColorsManager.primaryPinkColor, fontSize: 24)),
            const SizedBox(width: 8),
            const Icon(Icons.favorite, color: ColorsManager.primaryPinkColor)
          ],
        ),
        ...
        actions: [
          TextButton(
            ...
            child: Text("Close",
                style: TextStyles.font20BlackSemiMedium.copyWith(
                    color: ColorsManager.primaryPinkColor, fontSize: 18)),
          ),
        ],
      ),
    );
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  FeedbackHeader(
                      avgRating:
                          widget.getFeedbacksResponse.stats.averageRating,
                      totalReviews:
                          widget.getFeedbacksResponse.stats.totalReports),
                  FeedbacksListView(
